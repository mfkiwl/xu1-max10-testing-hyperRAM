	component tse_w_sfp is
		port (
			...
			tse_tse_mac_serdes_control_connection_export  : out std_logic;                                        -- export
	...
	u0 : component tse_w_sfp
		port map (
			...
			tse_tse_mac_serdes_control_connection_export  => CONNECTED_TO_tse_tse_mac_serdes_control_connection_export,  -- tse_tse_mac_serdes_control_connection.export
			tse_tse_mac_serial_connection_txp             => CONNECTED_TO_tse_tse_mac_serial_connection_txp,             --         tse_tse_mac_serial_connection.txp
			tse_tse_mac_serial_connection_rxp             => CONNECTED_TO_tse_tse_mac_serial_connection_rxp,             --                                      .rxp
