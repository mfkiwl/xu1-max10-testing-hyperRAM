	component tse_w_sgdma_2_intercon_rgmii is
		port (
	...
	end component tse_w_sgdma_2_intercon_rgmii;

	u0 : component tse_w_sgdma_2_intercon_rgmii
		port map (
			...
			tse_mac_mac_misc_connection_magic_wakeup  => CONNECTED_TO_tse_mac_mac_misc_connection_magic_wakeup,  --         tse_mac_mac_misc_connection.magic_wakeup
