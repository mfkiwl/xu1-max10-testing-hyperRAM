...
# +-----------------------------------
# | 
# | fifoed_avalon_uart "FIFOed UART (RS-232 serial port)9.0" v9.0
...
set_module_property VERSION 9.1.0
set_module_property GROUP "Interface Protocols/Serial"
set_module_property DISPLAY_NAME "FIFOed UART (RS-232 serial port)9.1.0"
...
set_parameter_property use_timout DISPLAY_NAME "Enable Timout "
