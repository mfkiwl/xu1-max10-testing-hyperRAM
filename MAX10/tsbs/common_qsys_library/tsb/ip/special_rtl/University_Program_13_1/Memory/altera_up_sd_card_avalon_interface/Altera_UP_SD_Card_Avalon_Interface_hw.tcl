...
add_interface_port conduit_end b_SD_cmd_in export  Input 1
add_interface_port conduit_end b_SD_dat_in export  Input 1
add_interface_port conduit_end b_SD_dat3_in export Input 1
add_interface_port conduit_end o_SD_clock export   Output 1

add_interface_port conduit_end b_SD_cmd_out export  Output 1
add_interface_port conduit_end b_SD_dat_out export  Output 1
add_interface_port conduit_end b_SD_dat3_out export Output 1

add_interface_port conduit_end b_SD_cmd_oe export  Output 1
add_interface_port conduit_end b_SD_dat_oe export  Output 1
add_interface_port conduit_end b_SD_dat3_oe export Output 1
