...
set_module_property TOP_LEVEL_HDL_FILE udp_payload_inserter.v
set_module_property TOP_LEVEL_HDL_MODULE udp_payload_inserter
...
# | files
# | 
add_file udp_payload_inserter.v {SYNTHESIS SIMULATION}
# | 
# +-----------------------------------
