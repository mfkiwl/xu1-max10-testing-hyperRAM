	...
	u0 : component tse_w_msgdma_2_ic_mii
		port map (
			...
			sgdma_tx_m_read_address                   => CONNECTED_TO_sgdma_tx_m_read_address,                   --                     sgdma_tx_m_read.address
			sgdma_tx_m_read_read                      => CONNECTED_TO_sgdma_tx_m_read_read,                      --                                    .read
			sgdma_tx_m_read_byteenable                => CONNECTED_TO_sgdma_tx_m_read_byteenable,                --                                    .byteenable
			sgdma_tx_m_read_readdata                  => CONNECTED_TO_sgdma_tx_m_read_readdata,                  --                                    .readdata
			...
			sgdma_rx_m_write_address                  => CONNECTED_TO_sgdma_rx_m_write_address,                  --                    sgdma_rx_m_write.address
			...
			sgdma_rx_m_write_waitrequest              => CONNECTED_TO_sgdma_rx_m_write_waitrequest,              --                                    .waitrequest
