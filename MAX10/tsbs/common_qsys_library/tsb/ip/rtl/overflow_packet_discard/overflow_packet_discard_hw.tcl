...
# | 
set_module_property DESCRIPTION "This component provides an elastic overflow buffer that discards packets arriving too quickly to be consumed by downstream peripherals."
set_module_property NAME overflow_packet_discard
set_module_property VERSION 1.0
set_module_property GROUP "Packet Processing"
set_module_property AUTHOR RSF
set_module_property DISPLAY_NAME overflow_packet_discard
set_module_property TOP_LEVEL_HDL_FILE overflow_packet_discard.v
set_module_property TOP_LEVEL_HDL_MODULE overflow_packet_discard
...
# | files
# | 
add_file overflow_packet_discard.v {SYNTHESIS SIMULATION}
add_file opd_data_fifo.v {SYNTHESIS SIMULATION}
add_file opd_status_fifo.v {SYNTHESIS SIMULATION}
# | 
# +-----------------------------------
