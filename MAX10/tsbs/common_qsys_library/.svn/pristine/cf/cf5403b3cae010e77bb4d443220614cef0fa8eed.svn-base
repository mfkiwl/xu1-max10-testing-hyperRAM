...
set_module_property NAME dual_port_mem_w_one_byteen
set_module_property DISPLAY_NAME {Dual Port M10K Mixed Width Ramw. byteenable only on S1 interface}
...
set_parameter_property dualPort DEFAULT_VALUE {true}                   
...
set_parameter_property dualPort VISIBLE {0}                    
...
set_parameter_property ecc_enabled VISIBLE {0}
