	component linnux_support_simplified is
		port (
			...
			uart_11_external_connection_rxd                  : in  std_logic                     := 'X';             -- rxd
			uart_11_external_connection_txd                  : out std_logic;                                        -- txd
			uart_11_irq_irq                                  : out std_logic;                                        -- irq
			uart_12_external_connection_rxd                  : in  std_logic                     := 'X';             -- rxd
			uart_12_external_connection_txd                  : out std_logic;                                        -- txd
			uart_12_irq_irq                                  : out std_logic;                                        -- irq
			...
			uart_1_irq_irq                                   : out std_logic;                                        -- irq
			uart_2_external_connection_rxd                   : in  std_logic                     := 'X';             -- rxd
			uart_2_external_connection_txd                   : out std_logic;                                        -- txd
			uart_2_irq_irq                                   : out std_logic;                                        -- irq
			uart_3_external_connection_rxd                   : in  std_logic                     := 'X';             -- rxd
			uart_3_external_connection_txd                   : out std_logic;                                        -- txd
			uart_3_irq_irq                                   : out std_logic;                                        -- irq
			uart_4_external_connection_rxd                   : in  std_logic                     := 'X';             -- rxd
			uart_4_external_connection_txd                   : out std_logic;                                        -- txd
			uart_4_irq_irq                                   : out std_logic;                                        -- irq
			uart_5_external_connection_rxd                   : in  std_logic                     := 'X';             -- rxd
			uart_5_external_connection_txd                   : out std_logic;                                        -- txd
			uart_5_irq_irq                                   : out std_logic;                                        -- irq
			uart_6_external_connection_rxd                   : in  std_logic                     := 'X';             -- rxd
			uart_6_external_connection_txd                   : out std_logic;                                        -- txd
			uart_6_irq_irq                                   : out std_logic;                                        -- irq
			...
			uart_8_external_connection_rxd                   : in  std_logic                     := 'X';             -- rxd
			uart_8_external_connection_txd                   : out std_logic;                                        -- txd
			uart_8_irq_irq                                   : out std_logic;                                        -- irq
			uart_9_external_connection_rxd                   : in  std_logic                     := 'X';             -- rxd
			uart_9_external_connection_txd                   : out std_logic;                                        -- txd
			uart_9_irq_irq                                   : out std_logic;                                        -- irq
	...
	end component linnux_support_simplified;

	u0 : component linnux_support_simplified
		port map (
			...
			uart_11_external_connection_rxd                  => CONNECTED_TO_uart_11_external_connection_rxd,                  --               uart_11_external_connection.rxd
			uart_11_external_connection_txd                  => CONNECTED_TO_uart_11_external_connection_txd,                  --                                          .txd
			uart_11_irq_irq                                  => CONNECTED_TO_uart_11_irq_irq,                                  --                               uart_11_irq.irq
			uart_12_external_connection_rxd                  => CONNECTED_TO_uart_12_external_connection_rxd,                  --               uart_12_external_connection.rxd
			uart_12_external_connection_txd                  => CONNECTED_TO_uart_12_external_connection_txd,                  --                                          .txd
			uart_12_irq_irq                                  => CONNECTED_TO_uart_12_irq_irq,                                  --                               uart_12_irq.irq
			...
			uart_1_irq_irq                                   => CONNECTED_TO_uart_1_irq_irq,                                   --                                uart_1_irq.irq
			...
			uart_2_irq_irq                                   => CONNECTED_TO_uart_2_irq_irq,                                   --                                uart_2_irq.irq
			...
			uart_3_irq_irq                                   => CONNECTED_TO_uart_3_irq_irq,                                   --                                uart_3_irq.irq
			uart_4_external_connection_rxd                   => CONNECTED_TO_uart_4_external_connection_rxd,                   --                uart_4_external_connection.rxd
			uart_4_external_connection_txd                   => CONNECTED_TO_uart_4_external_connection_txd,                   --                                          .txd
			uart_4_irq_irq                                   => CONNECTED_TO_uart_4_irq_irq,                                   --                                uart_4_irq.irq
			uart_5_external_connection_rxd                   => CONNECTED_TO_uart_5_external_connection_rxd,                   --                uart_5_external_connection.rxd
			uart_5_external_connection_txd                   => CONNECTED_TO_uart_5_external_connection_txd,                   --                                          .txd
			uart_5_irq_irq                                   => CONNECTED_TO_uart_5_irq_irq,                                   --                                uart_5_irq.irq
			uart_6_external_connection_rxd                   => CONNECTED_TO_uart_6_external_connection_rxd,                   --                uart_6_external_connection.rxd
			uart_6_external_connection_txd                   => CONNECTED_TO_uart_6_external_connection_txd,                   --                                          .txd
			uart_6_irq_irq                                   => CONNECTED_TO_uart_6_irq_irq,                                   --                                uart_6_irq.irq
			...
			uart_8_external_connection_rxd                   => CONNECTED_TO_uart_8_external_connection_rxd,                   --                uart_8_external_connection.rxd
			uart_8_external_connection_txd                   => CONNECTED_TO_uart_8_external_connection_txd,                   --                                          .txd
			uart_8_irq_irq                                   => CONNECTED_TO_uart_8_irq_irq,                                   --                                uart_8_irq.irq
			uart_9_external_connection_rxd                   => CONNECTED_TO_uart_9_external_connection_rxd,                   --                uart_9_external_connection.rxd
			uart_9_external_connection_txd                   => CONNECTED_TO_uart_9_external_connection_txd,                   --                                          .txd
			uart_9_irq_irq                                   => CONNECTED_TO_uart_9_irq_irq,                                   --                                uart_9_irq.irq
