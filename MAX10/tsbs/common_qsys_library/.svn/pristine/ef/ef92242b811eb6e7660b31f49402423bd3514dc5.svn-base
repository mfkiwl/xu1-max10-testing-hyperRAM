	component linnux_support_reduced_uarts_even_more_min is
		port (
	...
	end component linnux_support_reduced_uarts_even_more_min;

	u0 : component linnux_support_reduced_uarts_even_more_min
		port map (
