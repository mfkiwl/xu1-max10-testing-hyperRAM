...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL my_altera_address_span_extender

add_fileset SIM_VERILOG SIM_VERILOG generate_sim_ver
set_fileset_property SIM_VERILOG TOP_LEVEL my_altera_address_span_extender

add_fileset SIM_VHDL SIM_VHDL generate_sim_vhd
set_fileset_property SIM_VHDL TOP_LEVEL my_altera_address_span_extender
# | 
# +-----------------------------------
...
proc generate_synth {output_name} {
        add_fileset_file my_altera_address_span_extender.sv SYSTEM_VERILOG PATH my_altera_address_span_extender.sv
}
...
proc generate_sim_vhd {output_name} {
        if { (1 == 1) && [file exist "./mentor/my_altera_address_span_extender.sv"] } {
            add_fileset_file ./mentor/my_altera_address_span_extender.sv SYSTEM_VERILOG_ENCRYPT PATH ./mentor/my_altera_address_span_extender.sv {MENTOR_SPECIFIC}
            add_fileset_file my_altera_address_span_extender.sv SYSTEM_VERILOG PATH my_altera_address_span_extender.sv {ALDEC_SPECIFIC CADENCE_SPECIFIC SYNOPYSYS_SPECIFIC} 
        } else {
            add_fileset_file my_altera_address_span_extender.sv SYSTEM_VERILOG PATH my_altera_address_span_extender.sv 
        }
...
set_interface_property windowed_slave isFlash 0
set_interface_property windowed_slave isMemoryDevice 1
set_interface_property windowed_slave isNonVolatileStorage 0
...
#
    ...
    set_parameter_value SUB_WINDOW_SPAN  [ format "%d %s" [ expr 1 << $sub_window_span_var ] $byteString ]
