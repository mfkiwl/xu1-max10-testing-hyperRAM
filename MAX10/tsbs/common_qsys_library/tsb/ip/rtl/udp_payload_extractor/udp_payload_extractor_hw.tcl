...
# | 
set_module_property DESCRIPTION "This component extracts the UDP payload from an Ethernet packet and transmits it in a RAW packet."
set_module_property NAME udp_payload_extractor
set_module_property VERSION 1.0
set_module_property GROUP "Packet Processing"
set_module_property AUTHOR RSF
set_module_property DISPLAY_NAME udp_payload_extractor
set_module_property TOP_LEVEL_HDL_FILE udp_payload_extractor.v
set_module_property TOP_LEVEL_HDL_MODULE udp_payload_extractor
...
# | files
# | 
add_file udp_payload_extractor.v {SYNTHESIS SIMULATION}
# | 
# +-----------------------------------
