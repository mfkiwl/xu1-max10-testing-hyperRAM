...
# module properties
set_module_property NAME {tse_w_sfp_2_intercon_no_mdio_export}
set_module_property DISPLAY_NAME {tse_w_sfp_2_intercon_no_mdio_export_display}
...
proc compose { } {
    ...
    add_instance tse tse_w_sgdma_2_intercon_no_mdio 1.0
