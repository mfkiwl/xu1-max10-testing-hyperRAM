...
# module properties
set_module_property NAME {tse_w_sfp_simple_2_intercon_export}
set_module_property DISPLAY_NAME {tse_w_sfp_simple_2_intercon_export_display}
...
proc compose { } {
    ...
    add_instance tse tse_w_sgdma_simple_2_intercon 1.0
