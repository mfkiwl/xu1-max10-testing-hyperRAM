...
# 
# opencores_i2c_lcd "I2C Master LCD (opencores.org)" v12.0
#  2012.07.16.09:24:51
...
# 
# module opencores_i2c_lcd
# 
set_module_property DESCRIPTION "I2C Master Peripheral from opencores.org for NewHaven I2C LCD"
set_module_property NAME opencores_i2c_lcd
set_module_property VERSION 12.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP "Interface Protocols/Serial"
set_module_property AUTHOR "adapted by MN after adapted by CR"
set_module_property DISPLAY_NAME "I2C Master LCD (opencores.org)"
...
set_fileset_property quartus_synth TOP_LEVEL opencores_i2c_lcd
set_fileset_property quartus_synth ENABLE_RELATIVE_INCLUDE_PATHS false
add_fileset_file opencores_i2c_lcd.v VERILOG PATH opencores_i2c_lcd.v
add_fileset_file opencores_lcd_i2c_master_top.v VERILOG PATH opencores_lcd_i2c_master_top.v
add_fileset_file opencores_lcd_i2c_master_defines.v VERILOG PATH opencores_lcd_i2c_master_defines.v
add_fileset_file opencores_lcd_i2c_master_byte_ctrl.v VERILOG PATH opencores_lcd_i2c_master_byte_ctrl.v
add_fileset_file opencores_lcd_i2c_master_bit_ctrl.v VERILOG PATH opencores_lcd_i2c_master_bit_ctrl.v
add_fileset_file opencores_lcd_timescale.v VERILOG PATH opencores_lcd_timescale.v


add_fileset sim_verilog SIM_VERILOG "" "Verilog Simulation"
set_fileset_property sim_verilog TOP_LEVEL opencores_i2c_lcd
