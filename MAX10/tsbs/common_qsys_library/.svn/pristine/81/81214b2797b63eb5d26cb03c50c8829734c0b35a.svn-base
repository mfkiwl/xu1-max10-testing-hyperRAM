...
set_module_property NAME dma_checksum_read_master
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property GROUP "Modular_DMA"
set_module_property AUTHOR JCJB
set_module_property DISPLAY_NAME "Checksum Read Master"
set_module_property TOP_LEVEL_HDL_FILE checksum_read_master.v
set_module_property TOP_LEVEL_HDL_MODULE checksum_read_master
...
# | files
# | 
add_file checksum_read_master.v {SYNTHESIS SIMULATION}
add_file checksum_MM_to_ST_Adapter.v {SYNTHESIS SIMULATION}
add_file checksum_read_burst_control.v {SYNTHESIS SIMULATION}
# | 
# +-----------------------------------
