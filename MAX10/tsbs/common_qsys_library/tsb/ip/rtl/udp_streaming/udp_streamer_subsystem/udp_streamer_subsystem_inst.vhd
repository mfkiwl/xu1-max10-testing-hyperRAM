	...
	u0 : component udp_streamer_subsystem
		port map (
			clk_100_clk                                => CONNECTED_TO_clk_100_clk,                                --                      clk_100.clk
			dc_fifo_0_in_clk_clk                       => CONNECTED_TO_dc_fifo_0_in_clk_clk,                       --             dc_fifo_0_in_clk.clk
			dc_fifo_1_in_clk_clk                       => CONNECTED_TO_dc_fifo_1_in_clk_clk,                       --             dc_fifo_1_in_clk.clk
			dc_fifo_2_in_clk_clk                       => CONNECTED_TO_dc_fifo_2_in_clk_clk,                       --             dc_fifo_2_in_clk.clk
			dc_fifo_3_in_clk_clk                       => CONNECTED_TO_dc_fifo_3_in_clk_clk,                       --             dc_fifo_3_in_clk.clk
			...
			udp_inserter_1_snk_data                    => CONNECTED_TO_udp_inserter_1_snk_data,                    --           udp_inserter_1_snk.data
			udp_inserter_1_snk_valid                   => CONNECTED_TO_udp_inserter_1_snk_valid,                   --                             .valid
			udp_inserter_1_snk_ready                   => CONNECTED_TO_udp_inserter_1_snk_ready,                   --                             .ready
			udp_inserter_1_snk_startofpacket           => CONNECTED_TO_udp_inserter_1_snk_startofpacket,           --                             .startofpacket
			udp_inserter_1_snk_endofpacket             => CONNECTED_TO_udp_inserter_1_snk_endofpacket,             --                             .endofpacket
			udp_inserter_1_snk_empty                   => CONNECTED_TO_udp_inserter_1_snk_empty,                   --                             .empty
			udp_inserter_2_snk_data                    => CONNECTED_TO_udp_inserter_2_snk_data,                    --           udp_inserter_2_snk.data
			udp_inserter_2_snk_valid                   => CONNECTED_TO_udp_inserter_2_snk_valid,                   --                             .valid
			udp_inserter_2_snk_ready                   => CONNECTED_TO_udp_inserter_2_snk_ready,                   --                             .ready
			udp_inserter_2_snk_startofpacket           => CONNECTED_TO_udp_inserter_2_snk_startofpacket,           --                             .startofpacket
			udp_inserter_2_snk_endofpacket             => CONNECTED_TO_udp_inserter_2_snk_endofpacket,             --                             .endofpacket
			udp_inserter_2_snk_empty                   => CONNECTED_TO_udp_inserter_2_snk_empty,                   --                             .empty
			udp_inserter_3_snk_data                    => CONNECTED_TO_udp_inserter_3_snk_data,                    --           udp_inserter_3_snk.data
			udp_inserter_3_snk_valid                   => CONNECTED_TO_udp_inserter_3_snk_valid,                   --                             .valid
			udp_inserter_3_snk_ready                   => CONNECTED_TO_udp_inserter_3_snk_ready,                   --                             .ready
			udp_inserter_3_snk_startofpacket           => CONNECTED_TO_udp_inserter_3_snk_startofpacket,           --                             .startofpacket
			udp_inserter_3_snk_endofpacket             => CONNECTED_TO_udp_inserter_3_snk_endofpacket,             --                             .endofpacket
			udp_inserter_3_snk_empty                   => CONNECTED_TO_udp_inserter_3_snk_empty                    --                             .empty
		);
