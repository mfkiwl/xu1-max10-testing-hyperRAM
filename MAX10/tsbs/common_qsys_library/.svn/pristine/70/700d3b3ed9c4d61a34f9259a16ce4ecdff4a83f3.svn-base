# +-----------------------------------
# | module griffin_udp_payload_inserter
# | 
set_module_property DESCRIPTION "This component inserts RAW data into a UDP packet for Ethernet transmission."
set_module_property NAME griffin_udp_payload_inserter
set_module_property VERSION 1.0
set_module_property GROUP "Packet Processing"
set_module_property AUTHOR RSF
set_module_property DISPLAY_NAME griffin_udp_payload_inserter
set_module_property TOP_LEVEL_HDL_FILE griffin_udp_payload_inserter.v
set_module_property TOP_LEVEL_HDL_MODULE griffin_udp_payload_inserter
...
# | files
# | 
add_file griffin_udp_payload_inserter.v {SYNTHESIS SIMULATION}
# | 
# +-----------------------------------
...
set_interface_property s0 addressSpan 64
