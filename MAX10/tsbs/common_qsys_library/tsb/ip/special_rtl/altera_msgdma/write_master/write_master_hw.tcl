...
proc sim_callback_procedure_vhdl { entity_name } {
   if {0} { 
	  add_fileset_file mentor/write_master.v VERILOG_ENCRYPT PATH "mentor/write_master.v" {MENTOR_SPECIFIC}
	  add_fileset_file mentor/byte_enable_generator.v VERILOG_ENCRYPT PATH "mentor/byte_enable_generator.v" {MENTOR_SPECIFIC}
	  add_fileset_file mentor/ST_to_MM_Adapter.v VERILOG_ENCRYPT PATH "mentor/ST_to_MM_Adapter.v" {MENTOR_SPECIFIC}
	  add_fileset_file mentor/write_burst_control.v VERILOG_ENCRYPT PATH "mentor/write_burst_control.v" {MENTOR_SPECIFIC}
   }

   add_fileset_file dispatcher.v VERILOG PATH "./dispatcher.v" {{ALDEC_SPECIFIC} {CADENCE_SPECIFIC} {SYNOPSYS_SPECIFIC}}
   add_fileset_file byte_enable_generator.v VERILOG PATH "./byte_enable_generator.v" {{ALDEC_SPECIFIC} {CADENCE_SPECIFIC} {SYNOPSYS_SPECIFIC}}
   add_fileset_file ST_to_MM_Adapter.v VERILOG PATH "./ST_to_MM_Adapter.v" {{ALDEC_SPECIFIC} {CADENCE_SPECIFIC} {SYNOPSYS_SPECIFIC}}
   add_fileset_file write_burst_control.v VERILOG PATH "./write_burst_control.v" {{ALDEC_SPECIFIC} {CADENCE_SPECIFIC} {SYNOPSYS_SPECIFIC}}
}
# | 
# +-----------------------------------
