...
# module properties
set_module_property NAME {tse_w_sfp_2_intercon_rgmii_export}
set_module_property DISPLAY_NAME {tse_w_sfp_2_intercon_rgmii_export_display}
...
proc compose { } {
    ...
    add_instance clk_100 clock_source 14.1
    ...
    add_instance clk_50 clock_source 14.1
    ...
    add_instance clock_10 altera_clock_bridge 14.1
    ...
    add_instance mm_bridge_0 altera_avalon_mm_bridge 14.1
    ...
    add_instance tse tse_w_sgdma_2_intercon_rgmii 1.0
    ...
    add_interface tse_tse_mac_mac_rgmii_connection conduit end
    set_interface_property tse_tse_mac_mac_rgmii_connection EXPORT_OF tse.tse_mac_mac_rgmii_connection
    add_interface tse_tse_mac_mac_status_connection conduit end
    set_interface_property tse_tse_mac_mac_status_connection EXPORT_OF tse.tse_mac_mac_status_connection
    add_interface tse_tse_mac_pcs_mac_rx_clock_connection clock sink
    set_interface_property tse_tse_mac_pcs_mac_rx_clock_connection EXPORT_OF tse.tse_mac_pcs_mac_rx_clock_connection
    add_interface tse_tse_mac_pcs_mac_tx_clock_connection clock sink
    set_interface_property tse_tse_mac_pcs_mac_tx_clock_connection EXPORT_OF tse.tse_mac_pcs_mac_tx_clock_connection
