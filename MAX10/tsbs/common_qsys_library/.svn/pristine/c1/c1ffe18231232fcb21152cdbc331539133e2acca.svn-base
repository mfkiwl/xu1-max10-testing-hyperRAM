...
# *******************************************************************************
#
# MODULE_NAME = five_lane_seriallite_tx_only_constraints.tcl
# COMPANY     = Altera Corporation, Altera Ottawa Technology Center
# WEB         = www.altera.com
#
# FUNCTIONAL_DESCRIPTION :
#    SLITE-II Constraint file. Used by Quartus II.
#    To use this constraint file (assuming the name of this file is five_lane_seriallite_tx_only_constraints.tcl ):
#       -create a Quartus II project
#       - copy this constraint file into the project directory
#       - open the project
#       - run this constraint file
#           in the TCL Console:  >source five_lane_seriallite_tx_only_constraints.tcl
#           or,
#           select Tools / TCL Scripts / five_lane_seriallite_tx_only_constraints.tcl
...
if { $using_sdc_comp == 0 } {
   ...
   set_global_assignment -name SDC_FILE five_lane_seriallite_tx_only.sdc
}
...
set_instance_assignment -name CUT ON -from * -to "*five_lane_seriallite_tx_only_slite2_top*meta*"
set_instance_assignment -name CUT ON -from * -to "*five_lane_seriallite_tx_only_slite2_top*wr_*sync*"
set_instance_assignment -name CUT ON -from * -to "*five_lane_seriallite_tx_only_slite2_top*rd_*sync*"
#set_false_path -from [get_pins -hierarchical *reset_d[2]|clk*]
set_instance_assignment -name CUT ON -from "*five_lane_seriallite_tx_only_slite2_top*reset_syncer|reset_d[2]" -to *
