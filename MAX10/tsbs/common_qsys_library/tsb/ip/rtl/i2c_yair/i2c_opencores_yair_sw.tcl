#
# i2c_opencores_yair_sw.tcl
#

# Create a new driver
create_driver i2c_opencores_yair__driver

# Associate it with some hardware known as "i2c_opencores_yair"
set_sw_property hw_class_name i2c_opencores_yair
...
# C/C++ source files
add_sw_property c_source HAL/src/i2c_opencores_yair.c

# Include files
add_sw_property include_source HAL/inc/i2c_opencores_yair.h
add_sw_property include_source inc/i2c_opencores_yair_regs.h
