	component tse_w_sgdma_simple_2_intercon_reduced_fifos is
		port (
	...
	end component tse_w_sgdma_simple_2_intercon_reduced_fifos;

	u0 : component tse_w_sgdma_simple_2_intercon_reduced_fifos
		port map (
			...
			tse_mac_pcs_ref_clk_clock_connection_clk           => CONNECTED_TO_tse_mac_pcs_ref_clk_clock_connection_clk,           -- tse_mac_pcs_ref_clk_clock_connection.clk
			tse_mac_serdes_control_connection_rx_recovclkout   => CONNECTED_TO_tse_mac_serdes_control_connection_rx_recovclkout,   --    tse_mac_serdes_control_connection.rx_recovclkout
			tse_mac_serdes_control_connection_reconfig_togxb   => CONNECTED_TO_tse_mac_serdes_control_connection_reconfig_togxb,   --                                     .reconfig_togxb
			tse_mac_serdes_control_connection_reconfig_fromgxb => CONNECTED_TO_tse_mac_serdes_control_connection_reconfig_fromgxb, --                                     .reconfig_fromgxb
			tse_mac_serial_connection_rxp                      => CONNECTED_TO_tse_mac_serial_connection_rxp,                      --            tse_mac_serial_connection.rxp
			tse_mac_serial_connection_txp                      => CONNECTED_TO_tse_mac_serial_connection_txp,                      --                                     .txp
