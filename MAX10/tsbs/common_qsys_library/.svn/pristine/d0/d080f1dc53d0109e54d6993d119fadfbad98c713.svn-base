...
set_parameter_property d5m_resolution ALLOWED_RANGES {"2592 x 1944" "2048 x 1536" "1536 x 1536" "1920 x 1080" "1600 x 1200" "1280 x 1024" "1280 x 720" "1024 x 768" "800 x 600" "640 x 480"}
...
#	set i2c_bus_mode [ format "I2C_BUS_MODE:1'b%d" [ string match "LCD Screen*" $device ] ]
	...
	if { $d5m_resolution == "2592 x 1944" } {
		...
		set d5m_column_bin	[ format "D5M_COLUMN_BIN:16'h0000" ]
		set d5m_row_bin		[ format "D5M_ROW_BIN:16'h0000" ]
	} elseif { $d5m_resolution == "1536 x 1536" } {
		set d5m_column_size	[ format "D5M_COLUMN_SIZE:16'd1535" ]
		set d5m_row_size		[ format "D5M_ROW_SIZE:16'd1535" ]
		set d5m_column_bin	[ format "D5M_COLUMN_BIN:16'h0000" ]
		set d5m_row_bin		[ format "D5M_ROW_BIN:16'h0000" ]
