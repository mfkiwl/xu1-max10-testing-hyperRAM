...
# | 
set_module_property DESCRIPTION "This component discards errored packets that arrive on its Avalon ST sink interface."
set_module_property NAME error_packet_discard
set_module_property VERSION 1.0
set_module_property GROUP "Packet Processing"
set_module_property AUTHOR RSF
set_module_property DISPLAY_NAME error_packet_discard
set_module_property TOP_LEVEL_HDL_FILE error_packet_discard.v
set_module_property TOP_LEVEL_HDL_MODULE error_packet_discard
...
# | files
# | 
add_file error_packet_discard.v {SYNTHESIS SIMULATION}
add_file epd_data_fifo.v {SYNTHESIS SIMULATION}
add_file epd_status_fifo.v {SYNTHESIS SIMULATION}
# | 
# +-----------------------------------
...
add_interface_port snk0 asi_snk0_error error Input 6
# | 
# +-----------------------------------
