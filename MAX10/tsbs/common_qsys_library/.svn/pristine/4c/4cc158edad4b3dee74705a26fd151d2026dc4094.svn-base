# +-----------------------------------
# | module alignment_pad_remover
# | 
set_module_property DESCRIPTION "This component removes two pad bytes from the begining of an Avalon ST packet."
set_module_property NAME alignment_pad_remover
set_module_property VERSION 1.0
set_module_property GROUP "Packet Processing"
set_module_property AUTHOR RSF
set_module_property DISPLAY_NAME alignment_pad_remover
set_module_property TOP_LEVEL_HDL_FILE alignment_pad_remover.v
set_module_property TOP_LEVEL_HDL_MODULE alignment_pad_remover
...
# | files
# | 
add_file alignment_pad_remover.v {SYNTHESIS SIMULATION}
# | 
# +-----------------------------------
