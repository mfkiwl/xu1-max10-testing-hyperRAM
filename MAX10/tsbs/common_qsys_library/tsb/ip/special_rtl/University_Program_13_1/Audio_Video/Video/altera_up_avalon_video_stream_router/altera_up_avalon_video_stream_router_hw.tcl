...
proc elaborate {} {
	...
	add_interface advanced_control conduit end 
	add_interface_port advanced_control force_stream_switches export Input 1
	add_interface_port advanced_control current_stream export Output 1
