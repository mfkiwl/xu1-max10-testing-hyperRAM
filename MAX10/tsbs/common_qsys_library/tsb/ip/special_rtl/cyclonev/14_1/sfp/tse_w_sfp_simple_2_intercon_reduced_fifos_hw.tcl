...
# module properties
set_module_property NAME {tse_w_sfp_simple_2_intercon_reduced_fifos_export}
set_module_property DISPLAY_NAME {tse_w_sfp_simple_2_intercon_reduced_fifos_export_display}
...
proc compose { } {
    ...
    add_instance clk_125_enet_base altera_clock_bridge 14.1
    ...
    add_instance tse tse_w_sgdma_simple_2_intercon_reduced_fifos 1.0
