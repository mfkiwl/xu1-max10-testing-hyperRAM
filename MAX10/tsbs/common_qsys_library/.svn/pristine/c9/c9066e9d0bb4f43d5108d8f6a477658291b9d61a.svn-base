...
proc sim_callback_procedure_vhdl { entity_name } {
   if {0} { 
	  add_fileset_file mentor/read_master.v VERILOG_ENCRYPT PATH "mentor/read_master.v" {MENTOR_SPECIFIC}
	  add_fileset_file mentor/MM_to_ST_Adapter.v VERILOG_ENCRYPT PATH "mentor/MM_to_ST_Adapter.v" {MENTOR_SPECIFIC}
	  add_fileset_file mentor/read_burst_control.v VERILOG_ENCRYPT PATH "mentor/read_burst_control.v" {MENTOR_SPECIFIC}
   }

   add_fileset_file dispatcher.v VERILOG PATH "./dispatcher.v" {{ALDEC_SPECIFIC} {CADENCE_SPECIFIC} {SYNOPSYS_SPECIFIC}}
   add_fileset_file MM_to_ST_Adapter.v VERILOG PATH "./MM_to_ST_Adapter.v" {{ALDEC_SPECIFIC} {CADENCE_SPECIFIC} {SYNOPSYS_SPECIFIC}}
   add_fileset_file read_burst_control.v VERILOG PATH "./read_burst_control.v" {{ALDEC_SPECIFIC} {CADENCE_SPECIFIC} {SYNOPSYS_SPECIFIC}}
}
# | 
# +-----------------------------------
