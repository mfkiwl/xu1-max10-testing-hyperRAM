#
# opencores_i2c_lcd_sw.tcl
#

# Create a new driver
create_driver opencores_i2c_lcd_driver

# Associate it with some hardware known as "opencores_i2c_lcd"
set_sw_property hw_class_name opencores_i2c_lcd
...
# C/C++ source files
add_sw_property c_source HAL/src/opencores_i2c_lcd.c
#add_sw_property c_source HAL/src/opencores_i2c_lcd_fd.c


# Include files
add_sw_property include_source HAL/inc/opencores_i2c_lcd.h
#add_sw_property include_source HAL/inc/opencores_i2c_lcd_fd.h
add_sw_property include_source inc/opencores_i2c_lcd_regs.h
